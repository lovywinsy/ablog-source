...
# Lovywinsy's Site build configuration file, created by
# `ablog start` on Thu Sep 17 22:38:06 2020.
#
...
blog_title = u'Lost my pieces'

# Base URL for the website, required for generating feeds.
# e.g. blog_baseurl = "http://example.com/"
blog_baseurl = u'https://lovywinsy.github.io/'
...
html_theme_options = {
    'github_button': False,
    'description': 'Elapsed pieces, whimsies and code snippets.'
}
...
htmlhelp_basename = 'LovywinsysSitedoc'


github_pages = 'lovywinsy'
